...
Optional fields:
- **Network** - Target network (TRC20, BEP20, ERC20, Polygon, Arbitrum). If omitted, customer selects on the payment page.
...
- [Getting Started](https://docs.payzcore.com/getting-started)
- [Webhooks Guide](https://docs.payzcore.com/guides/webhooks)
- [Supported Networks](https://docs.payzcore.com/guides/networks)
- [Error Reference](https://docs.payzcore.com/guides/errors)
